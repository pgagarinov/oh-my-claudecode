 ...
 */
export function mergeJsonShallow(path, patch) {
 ...
 */
export function setNestedJson(path, keyPath, value) {
    if (keyPath.length === 0) {
 ...
 */
export function mergeOmcConfig(patch, opts = {}) {
 ...
 */
export function mergeSettingsJson(patch, opts = {}) {
    const dir = opts.configDir ?? getClaudeConfigDir();
