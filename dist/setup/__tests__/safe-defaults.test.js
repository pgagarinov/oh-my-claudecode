...
describe('dumpSafeDefaultsAsJson()', () => {
    ...
    it('serializes phases as an array (not a Set)', () => {
        const parsed = JSON.parse(dumpSafeDefaultsAsJson());
    ...
    it('output round-trips through loadPreset()', () => {
        ...
        try {
            ...
            expect(Array.from(loaded.phases).sort()).toEqual(['claude-md', 'infra', 'integrations', 'welcome'].sort());
...
//# sourceMappingURL=safe-defaults.test.js.map