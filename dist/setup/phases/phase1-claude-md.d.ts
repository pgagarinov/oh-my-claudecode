 ...
 */
import { type InstallClaudeMdOptions, type InstallClaudeMdResult } from '../claude-md.js';
 ...
 */
export declare function runPhase1(options: SetupOptions, logger: Logger, deps?: Phase1Deps): Promise<Phase1Result>;
//# sourceMappingURL=phase1-claude-md.d.ts.map