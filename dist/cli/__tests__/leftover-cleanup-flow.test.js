...
// ---------------------------------------------------------------------------
let _nextAnswer = '';
function setNextAnswer(a) {
    _nextAnswer = a;
}
vi.mock('node:readline', () => ({
    createInterface: () => ({
        question: (_prompt, cb) => cb(_nextAnswer),
        close: () => { },
    }),
}));
const SAVED_KEYS = ['CLAUDE_CONFIG_DIR', 'OMC_PLUGIN_ROOT', 'CLAUDE_PLUGIN_ROOT'];
let tmpConfigDir;
let tmpPluginRoot;
let savedEnv;
...
//# sourceMappingURL=leftover-cleanup-flow.test.js.map